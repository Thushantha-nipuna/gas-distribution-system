                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('price_2_8kg') is-invalid @enderror" 
                               id="price_2_8kg" name="price_2_8kg" value="{{ old('price_2_8kg') }}">
                        @error('price_2_8kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('price_5kg') is-invalid @enderror" 
                               id="price_5kg" name="price_5kg" value="{{ old('price_5kg') }}">
                        @error('price_5kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('price_12_5kg') is-invalid @enderror" 
                               id="price_12_5kg" name="price_12_5kg" value="{{ old('price_12_5kg') }}">
                        @error('price_12_5kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
