...
@section('content')
<div class="container">
    <h1 class="mb-4">Edit Delivery Route</h1>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('route_name') is-invalid @enderror" 
                               id="route_name" name="route_name" value="{{ old('route_name', $deliveryRoute->route_name) }}" required>
                        @error('route_name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control @error('route_date') is-invalid @enderror" 
                               id="route_date" name="route_date" value="{{ old('route_date', $deliveryRoute->route_date->format('Y-m-d')) }}" required>
                        @error('route_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('driver_name') is-invalid @enderror" 
                               id="driver_name" name="driver_name" value="{{ old('driver_name', $deliveryRoute->driver_name) }}" required>
                        @error('driver_name')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('assistant_name') is-invalid @enderror" 
                               id="assistant_name" name="assistant_name" value="{{ old('assistant_name', $deliveryRoute->assistant_name) }}">
                ...
                <div class="row">
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="time" class="form-control @error('planned_start_time') is-invalid @enderror" 
                               id="planned_start_time" name="planned_start_time" value="{{ old('planned_start_time', $deliveryRoute->planned_start_time ? substr($deliveryRoute->planned_start_time, 0, 5) : '') }}">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="time" class="form-control @error('planned_end_time') is-invalid @enderror" 
                               id="planned_end_time" name="planned_end_time" value="{{ old('planned_end_time', $deliveryRoute->planned_end_time ? substr($deliveryRoute->planned_end_time, 0, 5) : '') }}">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="time" class="form-control @error('actual_start_time') is-invalid @enderror" 
                               id="actual_start_time" name="actual_start_time" value="{{ old('actual_start_time', $deliveryRoute->actual_start_time ? substr($deliveryRoute->actual_start_time, 0, 5) : '') }}">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="time" class="form-control @error('actual_end_time') is-invalid @enderror" 
                               id="actual_end_time" name="actual_end_time" value="{{ old('actual_end_time', $deliveryRoute->actual_end_time ? substr($deliveryRoute->actual_end_time, 0, 5) : '') }}">
