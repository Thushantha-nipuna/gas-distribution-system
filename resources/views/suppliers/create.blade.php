                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('rate_2_8kg') is-invalid @enderror" 
                               id="rate_2_8kg" name="rate_2_8kg" value="{{ old('rate_2_8kg', 0) }}" required>
                        @error('rate_2_8kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('rate_5kg') is-invalid @enderror" 
                               id="rate_5kg" name="rate_5kg" value="{{ old('rate_5kg', 0) }}" required>
                        @error('rate_5kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control @error('rate_12_5kg') is-invalid @enderror" 
                               id="rate_12_5kg" name="rate_12_5kg" value="{{ old('rate_12_5kg', 0) }}" required>
                        @error('rate_12_5kg')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
